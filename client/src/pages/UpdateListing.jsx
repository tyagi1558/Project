...
export default function UpdateListing() {
  ...
  useEffect(() => {
    const fetchListing = async () => {
      ...
      const res = await fetch(`https://project-2-b7bx.onrender.com/api/listing/get/${listingId}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setLoading(true);
      setError(false);
      const res = await fetch(`https://project-2-b7bx.onrender.com/api/listing/update/${params.listingId}`, {
        method: 'POST',
        headers: {
